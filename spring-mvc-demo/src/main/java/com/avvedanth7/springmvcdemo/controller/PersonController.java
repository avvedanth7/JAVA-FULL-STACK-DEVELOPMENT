package com.avvedanth7.springmvcdemo.controller;
...
import com.avvedanth7.springmvcdemo.service.PersonService;
...
public class PersonController {
	...
	public String savePerson(@ModelAttribute Person person) {
		...
		if (result != null) {
			this.msg = "PERSON SAVED SUCCESSFULLY ID: " + result.compareTo(result);
		} else {
